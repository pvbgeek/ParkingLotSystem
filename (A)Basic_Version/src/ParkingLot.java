...
public class ParkingLot {
    ...
    public static void main(String[] args) {
        ...
        // Creating Customer
        Customer piyush = new Customer("Piyush","UP85 AX 4269");
        ...
        Customer parth = new Customer("Parth","UP87 AY 6595");

        // Automated System Generating Ticket
        Ticket parthTicket = myParkingLot.automatedSystem.generateTicket(parth);

        // Printing Ticket Info
        System.out.println(parthTicket);
